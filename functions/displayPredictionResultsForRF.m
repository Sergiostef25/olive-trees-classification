function displayPredictionResultsForRF(rgbImg,XTestSet,Ypredicted)
%DISPLAYPREDICTIONRESULTSFORRF Display prediction results in the map
figure
imshow(rgbImg)

hold on

idxRightPrediction = XTestSet.labels == Ypredicted;
